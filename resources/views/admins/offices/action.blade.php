<span style="overflow: visible; position: relative; width: 110px;">
	...
	<a href="{{ route('admin-offices.edit', $office->id)}}" title="Edit" class="btn btn-sm btn-clean btn-icon btn-icon-md">
		<i class="fa fa-paint-brush text-green"></i>
	</a>

    <form action="{{route('admin-offices.destroy', $office->id)}}" method="post" onsubmit="return confirm('Are you sure want to delete ?');" style="display: inline;">
		{{ csrf_field()}}
